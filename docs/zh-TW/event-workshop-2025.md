...
!!! warning "籌備準備中⋯"
    ...
    - 目前是工作坊籌備中，我們預計在 2025/07 初宣傳與開放報名，如果您提前抵達這一頁面想要報名活動，可[加入群組信箱](./contact.md)即時收到我們的活動報名通知！

---

## :fontawesome-solid-users-gear: 籌備團隊
...
=== "2025/06"
    ...
    - [ ] `公告`{style="color: red;"} 籌備進度與持續招募工作人員。
    - [ ] `確認`{style="color: purple;"} 工作人員與小幫手名單。
    - [ ] `教材`{style="color: green;"} Tor/Tails 工作坊課程細節。
    - [ ] `教材`{style="color: green;"} OONI 工作坊課程細節。
