...
| <span style="background-color: green; color: #ffffff; font-weight: bold; padding:3px;border-radius: 5px;">圆桌讨论</span> | 2025/08/09<br>15:30<br>16:30 | <span style="color: green; font-weight: bold;">:material-chat-processing-outline:「推动一个去中心、开源协作的匿名网络推广计划」</span><br>:material-arrow-right-bottom:若以公民科技社区、开源社区协作模式进行推广，我们可以怎么分工？<br>:material-arrow-right-bottom:是否能建立一个“开源维运小组”（工作小组模式）维护 Tor/OONI 服务器、定期测试 ISP 封锁状况？<br>:material-arrow-right-bottom:有哪些非技术角色（设计、翻译、讲师、写手）可以参与？ |
